...
public class Vejirnik extends Nepritel implements NepritelInterface {
    ...
    private static final int PUVODNI_RYCHLOST = 1;
    private static int rychlost = PUVODNI_RYCHLOST;
    private static final double POMER_SIRKA = 0.08;
    private static final double POMER_VYSKA = 0.1;
    private static final int MEZERA = 110;
    Random randomCesta = new Random();

    public Vejirnik(ObservableList list) {
        super(list);
        this.HP = 2000;
    ...
    public void objevSe() {
        ...
        this.broukImage.setStyle("-fx-image: url('file:soubory/brouci/vejirnik_sprite_sheet.png')");
        nastavZacatek(this.Body.get(0));
        list.add(this.broukImage);
        listBrouku.add(vejirnik);
        zmenaVelikosti();
    }
    ...
    public void doselDoCile() {
        ...
        Mapa.odectiZivoty(300);
        uklid();
    }

    @Override
    public void zabit() {
        Mapa.prictiPenize(1000);
        uklid();
    }
