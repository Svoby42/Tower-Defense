...
public class Chrestovnik extends Nepritel implements NepritelInterface {
    ...
    private static final int MEZERA = 164;
    private static final int PUVODNI_RYCHLOST = 4;
    ...
    public Chrestovnik(ObservableList list) {
        super(list);
        this.HP = 20;
    ...
    public void objevSe() {
        ...
        this.broukImage.setStyle("-fx-image: url('file:soubory/brouci/chrestovnik_sprite_sheet.png')");
        nastavZacatek(this.Body.get(0));
        listBrouku.add(chrestovnik);
